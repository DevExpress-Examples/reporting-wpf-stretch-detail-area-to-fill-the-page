...
Namespace PageHeightDemo
    Public Class UsableDetailPageHeightConverter
        ...
        Public Function Convert(ByVal values() As Object, ByVal targetType As Type, _
        ...
        Public Function ConvertBack(ByVal value As Object, ByVal targetTypes() As Type, _
        ByVal parameter As Object, ByVal culture As CultureInfo) As Object() _
